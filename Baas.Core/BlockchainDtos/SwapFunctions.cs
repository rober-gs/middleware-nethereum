...
namespace Baas.Core.BlockchainDtos
{
    public class SwapFunctions
    {
        ...
        public partial class SwapParticipationFunction : SwapParticipationFunctionBase { }

        [Function("swapParticipation")]
        public class SwapParticipationFunctionBase : FunctionMessage
        {
            [Parameter("address[]", "participants", 1)]
            public virtual List<string> Participants { get; set; }
            [Parameter("uint256[]", "scores", 2)]
            public virtual List<BigInteger> Scores { get; set; }
            [Parameter("uint256[]", "quality", 3)]
            public virtual List<BigInteger> Quality { get; set; }
        }
